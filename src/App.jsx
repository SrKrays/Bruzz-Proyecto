...
export default function App() {
  ...
  // ── Console easter egg — firma oculta, no se ve en la web,
  //    solo para quien abra la consola del navegador. ──────────
  useEffect(() => {
    console.log(
      `%c
⠀⠀⠀⠀⢨⠊⠀⢀⢀⠀⠀⠀⠈⠺⡵⡱⠀⠀⠀⢠⠃⠀⡀⠀⠀⠀⠀⠀⠀⠀⠀⠀⡘⢰⡁⠉⠊⠙⢎⣆⠀⠀⠀⠀⢩⢀⠜⠀⠀⠀
...
%c
      By VindPath`,
      'color: #f5c842; font-family: monospace; font-size: 7px; line-height: 1;',
      'color: #f5c842; font-family: monospace; font-size: 14px; font-weight: bold; letter-spacing: 2px;'
    );
  }, []);
