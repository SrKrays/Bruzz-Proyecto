...
export const SUBCATEGORIAS = {
  ...
  bebidas: [
    ...
    { menuKey: 'vinos',      name: 'Vinos',       desc: 'Tinto, blanco, espumoso', imageUrl: 'https://images.unsplash.com/photo-1535958636474-b021ee887b13?w=600&q=80' },
  ],
};
...
export const MENU = {
  ...
  pizza: {
    ...
    items: [
      ...
      { name: 'Prosciutto Cotto',   price: '$22.000', desc: 'Pizza estilo napolitano, salsa de tomate fresca, mozzarella, jamón cocido, albahacas fresca, olivas verdes, orégano.',                                     imageUrl: 'https://images.unsplash.com/photo-1574071318508-1cdbab80d002?w=800&q=80' },
      { name: 'Fungo',              price: '$24.700', desc: 'Pizza estilo napolitano, salsa de tomate fresca, mozzarella, champignones y cherrys confitados en aceite de oliva, pesto Bruzz.',                                    imageUrl: 'https://images.unsplash.com/photo-1574071318508-1cdbab80d002?w=800&q=80' },
      ...
      { name: 'Pizza Bruzz',        price: '$24.500', desc: 'Pizza estilo napolitano, salsa de tomate fresca, mozzarella, cebolla caramelizada con un toque de roquefort, morrón, lomo ahumado, orégano.', badge: '✦ Firma',          imageUrl: 'https://images.unsplash.com/photo-1574071318508-1cdbab80d002?w=800&q=80' },
  ...
  calzone: {
    ...
    items: [
      ...
      { name: 'Calzone Fungo',            price: '$24.700', desc: 'Salsa de tomate fresca, mozzarella, champignones y cherrys confitados en aceite de oliva, pesto Bruzz, envuelto en masa de pizza estilo napolitano.', imageUrl: 'https://69f636d2a0be0e562863ff1f.imgix.net/cazone/e52c26c01fea14ac13443f7810be56fe.jpg' },
    ],
  },
  ...
  hamburgesas: {
    ...
    items: [
      { name: 'Simple',         price: '$12.000', desc: 'Pan de papa Americano, carne de res, lactonesa de la casa, cheddar y papas fritas.',                                                                                 imageUrl: 'https://images.unsplash.com/photo-1568901346375-23c9450c58cd?w=800&q=80' },
      { name: 'Completa',       price: '$13.900', desc: 'Pan de papa Americano, carne de res, lactonesa de la casa, lechuga, tomates fresco, bacon, cheddar y papas fritas.',                                                                                 imageUrl: 'https://images.unsplash.com/photo-1568901346375-23c9450c58cd?w=800&q=80' },
      { name: 'Hamb Bruzz',     price: '$14.600', desc: 'Pan de papa Americano, carne de res, cheddar, salsa Bruzz, rúcula, cebolla morada, bacon, pepinos encurtidos, barbacoa y papas fritas.', badge: '✦ Firma',                       imageUrl: 'https://images.unsplash.com/photo-1568901346375-23c9450c58cd?w=800&q=80' },
      ...
      { name: 'Combo Simple',   price: '$14.600', desc: 'Hamburguesa simple mas gaseosa de 500ml.', imageUrl: 'https://images.unsplash.com/photo-1568901346375-23c9450c58cd?w=800&q=80' },
      { name: 'Combo Completa', price: '$16.300', desc: 'Hamburguesa completa mas gaseosa de 500lml.', imageUrl: 'https://images.unsplash.com/photo-1568901346375-23c9450c58cd?w=800&q=80' },
      { name: 'Combo Bruzz',    price: '$17.000', desc: 'Hamburguesa bruzz mas gaseosa de 500ml.', imageUrl: 'https://images.unsplash.com/photo-1568901346375-23c9450c58cd?w=800&q=80' },
      ...
      { name: 'Hamburgesa Bambino',   price: '$14.600', desc: 'Burger Simple + Gaseosa + Helado + Jugete todo en UNO', imageUrl: 'https://images.unsplash.com/photo-1568901346375-23c9450c58cd?w=800&q=80' },
  ...
  sandwich: {
    ...
    items: [
      ...
      { name: 'Macerata',    price: '$11.900', desc: 'Pan artesanal, lactonesa de la casa, queso dambo, jamón crudo, tomates frescos, rúcula, y papas fritas.', imageUrl: 'https://69f636d2a0be0e562863ff1f.imgix.net/pagweb/eeeeeeeeee.jpg' },
      ...
      { name: 'Ternera',     price: '$19.900', desc: 'Pan de focaccia, lactonesa de albahaca, rúcula, tomates frescos, ternera desmenuzada en vino tinto y papas fritas.', imageUrl: 'https://69f636d2a0be0e562863ff1f.imgix.net/pagweb/eeeeeeeeee.jpg' },
    ],
  },
  ...
  sinAlcohol: {
    ...
    items: [
      { name: 'Agua mineral',  price: '$3.700', desc: '', imageUrl: '' },
      { name: 'Agua con gas',  price: '$3.700', desc: '', imageUrl: '' },
      { name: 'Agua Saborisada',  price: '$3.900', desc: '', imageUrl: '' },
      { name: 'Coca cola 500ml', price: '$3.900', desc: '', imageUrl: '' },
      { name: 'Coca cola Zero 500ml', price: '$3.900', desc: '', imageUrl: '' },
      { name: 'Fanta', price: '$3.900', desc: '', imageUrl: '' },
      { name: 'Srite', price: '$3.900', desc: '', imageUrl: 'https://69f969104ee83435ba386e9c.imgix.net/Bruzz/Sprite.jpg' },
      { name: 'Coca Cola 1.5L', price: '$7.800', desc: '', imageUrl: '' },
      { name: 'Limonada Litro',      price: '$ 7.200 ', desc: 'Limón exprimido, hielo, azúcar.', imageUrl: '' },
    ],
  },
  ...
  cervezas: {
    ...
    items: [
      { sep: 'Pintas Tiradas' },
      { name: 'Blonde Ale',     price: '$4.700', desc: 'KRAL alc. 4,5%. Ligera, moderado aroma dulce maltoso, bajo amargor y leve cítrico.', imageUrl: 'https://images.unsplash.com/photo-1535958636474-b021ee887b13?w=800&q=80' },
      { name: 'IPA', price: '$6.000', desc: 'KRAL. ALC. 5,3% De cuerpo medio, con marcados aromas y sabores cítricos florales.', imageUrl: 'https://images.unsplash.com/photo-1535958636474-b021ee887b13?w=800&q=80' },
      { name: ' IRISH RED',      price: '$5.200', desc: 'UN TAL RENE . alc 5%. Roja, con notas dulces, frutal.', imageUrl: 'https://images.unsplash.com/photo-1535958636474-b021ee887b13?w=800&q=80' },
      { name: 'NEGRA STOUT',     price: '$6.200', desc: '372. Negra, notas a cafe. alc. 4.8% de amargor bajo.', imageUrl: 'https://images.unsplash.com/photo-1535958636474-b021ee887b13?w=800&q=80' },
      { name: ' HONEY BLUEBERRY',      price: '$5.600', desc: 'UN TAL RENE. 6% Alc. Rubia, endulzada con miel y notas de blueberry.', imageUrl: 'https://images.unsplash.com/photo-1535958636474-b021ee887b13?w=800&q=80' },
      { name: ' IRISH RED',      price: '$4.800', desc: 'BUFON DEL REY. 4,2% alc. Rubia, ligera y refrescante. De amargor bajo. ( Medalla de ORO 2023)', imageUrl: 'https://images.unsplash.com/photo-1535958636474-b021ee887b13?w=800&q=80' },
      
            { sep: 'Cervezas en Botella ' },
      { name: 'IMPERIAL LITRO',     price: '9.000', desc: 'Golden o Extra Lagger', imageUrl: 'https://images.unsplash.com/photo-1535958636474-b021ee887b13?w=800&q=80' },
      { name: 'HEINEKEN LITRO ', price: '$9.900', desc: '', imageUrl: 'https://images.unsplash.com/photo-1535958636474-b021ee887b13?w=800&q=80' },
      { name: 'Heineken lata',      price: '$4.200', desc: '', imageUrl: 'https://images.unsplash.com/photo-1535958636474-b021ee887b13?w=800&q=80' },
      { name: 'HEINEKEN 330 CC',     price: '$4.200', desc: '', imageUrl: 'https://images.unsplash.com/photo-1535958636474-b021ee887b13?w=800&q=80' },
      { name: 'HEINEKEN Zero 330 CC',     price: '$3.600', desc: '', imageUrl: 'https://images.unsplash.com/photo-1535958636474-b021ee887b13?w=800&q=80' },
      { name: 'IMPERIAL 330 CC',     price: '$3.600', desc: '', imageUrl: 'https://images.unsplash.com/photo-1535958636474-b021ee887b13?w=800&q=80' },
      { name: 'BLUE MOON 335 CC',     price: '$6.000', desc: '', imageUrl: 'https://images.unsplash.com/photo-1535958636474-b021ee887b13?w=800&q=80' },

                  { sep: 'Para Disfrutar con amigos ' },
{ name: 'Balde Heineken x6', price: '$21.000', desc: 'Balde 6x5 Heineken 330cc.', badge: ' Balde', imageUrl: 'https://images.unsplash.com/photo-1551024709-8f23befc6f87?w=800&q=80' },
{ name: 'Balde Heineken Cero x6', price: '$18.000', desc: 'Balde 6x5 Heineken Cero alcohol 330cc.', badge: ' Balde', imageUrl: 'https://images.unsplash.com/photo-1551024709-8f23befc6f87?w=800&q=80' },
{ name: 'Balde Imperial Golden x6', price: '$18.000', desc: 'Balde 6x5 Imperial Golden 330cc.', badge: ' Balde', imageUrl: 'https://images.unsplash.com/photo-1551024709-8f23befc6f87?w=800&q=80' },
{ name: 'Balde Blue Moon x6', price: '$30.000', desc: 'Balde 6x5 Blue Moon 355cc.', badge: ' Balde', imageUrl: 'https://images.unsplash.com/photo-1551024709-8f23befc6f87?w=800&q=80' },
    ...
    items: [
      { sep: 'Vinos' },
{ name: 'Santa Julia Chardonnay', price: '$8.500', desc: 'Vino blanco Chardonnay, Santa Julia.', imageUrl: 'https://images.unsplash.com/photo-1551024709-8f23befc6f87?w=800&q=80' },
{ name: 'Espumante Dada 7', price: '$19.900', desc: 'Espumante Dada 7.', imageUrl: 'https://images.unsplash.com/photo-1551024709-8f23befc6f87?w=800&q=80' },
{ name: 'Luigi Bosca Malbec', price: '$25.300', desc: 'Vino tinto Malbec, Luigi Bosca.', imageUrl: 'https://images.unsplash.com/photo-1551024709-8f23befc6f87?w=800&q=80' },
{ name: 'Alma Mora Malbec', price: '$9.500', desc: 'Vino tinto Malbec, Alma Mora.', imageUrl: 'https://images.unsplash.com/photo-1551024709-8f23befc6f87?w=800&q=80' },
{ name: 'Cordero con Piel de Lobo Cabernet Sauvignon', price: '$13.500', desc: 'Vino tinto Cabernet Sauvignon, Cordero con Piel de Lobo.', imageUrl: 'https://images.unsplash.com/photo-1551024709-8f23befc6f87?w=800&q=80' },
{ name: 'Cordero con Piel de Lobo Blanco Dulce', price: '$12.900', desc: 'Vino blanco dulce, Cordero con Piel de Lobo.', imageUrl: 'https://images.unsplash.com/photo-1551024709-8f23befc6f87?w=800&q=80' },
{ name: 'Fond de Cave Chardonnay', price: '$11.500', desc: 'Vino blanco Chardonnay, Fond de Cave.', imageUrl: 'https://images.unsplash.com/photo-1551024709-8f23befc6f87?w=800&q=80' },
{ name: 'Alma Mora Cabernet Sauvignon', price: '$9.500', desc: 'Vino tinto Cabernet Sauvignon, Alma Mora.', imageUrl: 'https://images.unsplash.com/photo-1551024709-8f23befc6f87?w=800&q=80' },
    ],
  },
...
export const POSTRES = [
  ...
  { name: 'Flan Con Dulse de Leche', price: '$5.800', desc: 'Flan Espectacula con Dulse de Leche', imageUrl: 'https://69f636d2a0be0e562863ff1f.imgix.net/postres/273a1cba2505799c5ec72003e7fd18eb.jpg' },
    ...
    { sep: 'Cafetería' },
{ name: 'Corto', price: '$2.500', desc: 'Café chico.', imageUrl: 'https://images.unsplash.com/photo-1551024709-8f23befc6f87?w=800&q=80' },
{ name: 'Lungo', price: '$2.600', desc: 'Café en jarro.', imageUrl: 'https://images.unsplash.com/photo-1551024709-8f23befc6f87?w=800&q=80' },
{ name: 'Doble', price: '$3.000', desc: 'Café doble.', imageUrl: 'https://images.unsplash.com/photo-1551024709-8f23befc6f87?w=800&q=80' },
{ name: 'XL', price: '$3.700', desc: 'Café XL.', imageUrl: 'https://images.unsplash.com/photo-1551024709-8f23befc6f87?w=800&q=80' },
{ name: 'Café con Leche', price: '$3.000', desc: 'Café con leche.', imageUrl: 'https://images.unsplash.com/photo-1551024709-8f23befc6f87?w=800&q=80' },
{ name: 'Té', price: '$2.000', desc: 'Té. Consultá las variedades disponibles.', imageUrl: 'https://images.unsplash.com/photo-1551024709-8f23befc6f87?w=800&q=80' },
{ name: 'Chocolatada', price: '$3.000', desc: 'Chocolatada caliente.', imageUrl: 'https://images.unsplash.com/photo-1551024709-8f23befc6f87?w=800&q=80' },
{ sep: 'Especiales' },
{ name: 'Flat White', price: '$3.000', desc: 'Café doble filtro con leche texturizada.', imageUrl: 'https://images.unsplash.com/photo-1551024709-8f23befc6f87?w=800&q=80' },
{ name: 'Bombón', price: '$4.200', desc: 'Café, leche condensada, leche texturizada y crema batida.', imageUrl: 'https://images.unsplash.com/photo-1551024709-8f23befc6f87?w=800&q=80' },
{ name: 'Macchiato', price: '$2.800', desc: 'Café con espuma de leche.', imageUrl: 'https://images.unsplash.com/photo-1551024709-8f23befc6f87?w=800&q=80' },
{ name: 'Latte Moka', price: '$4.200', desc: 'Café, sirope de chocolate y leche texturizada.', imageUrl: 'https://images.unsplash.com/photo-1551024709-8f23befc6f87?w=800&q=80' },
{ name: 'Submarino', price: '$3.700', desc: 'Leche texturizada con chocolate en barra.', imageUrl: 'https://images.unsplash.com/photo-1551024709-8f23befc6f87?w=800&q=80' },
{ name: 'Affogato', price: '$4.500', desc: 'Café con bocha de helado de crema americana.', imageUrl: 'https://images.unsplash.com/photo-1551024709-8f23befc6f87?w=800&q=80' },
{ name: 'Ristretto', price: '$2.500', desc: 'Shot de café concentrado.', imageUrl: 'https://images.unsplash.com/photo-1551024709-8f23befc6f87?w=800&q=80' },
{ name: 'Latte Bruzz', price: '$4.200', desc: 'Café, leche condensada, salsa de chocolate, leche texturizada y cacao amargo.', badge: '✦ Casa', imageUrl: 'https://images.unsplash.com/photo-1551024709-8f23befc6f87?w=800&q=80' },
{ name: 'Latte Avellanas', price: '$4.200', desc: 'Café, sirope de avellana y leche texturizada.', imageUrl: 'https://images.unsplash.com/photo-1551024709-8f23befc6f87?w=800&q=80' },
{ name: 'Licuados', price: '$5.000', desc: 'Consultá las opciones disponibles.', imageUrl: 'https://images.unsplash.com/photo-1551024709-8f23befc6f87?w=800&q=80' },
{ name: 'Limonada', price: '$6.900', desc: 'Limonada fresca.', imageUrl: 'https://images.unsplash.com/photo-1551024709-8f23befc6f87?w=800&q=80' },
