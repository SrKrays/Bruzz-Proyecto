...
export const MENU = {
  ...
  pizza: {
    ...
    items: [
      ...
      { name: 'Fugazza', price: '$22.600', desc: 'Pizza estilo napolitano, mozzarella, abundante cebolla en pluma, aceite de oliva, aceitunas negras, sal de campo , Chimi Pizzero de la casa.', imageUrl: 'https://bruzz.com.ar/img/pizzageneral.jpg' },
    ],
  },
  ...
  sinAlcohol: {
    ...
    items: [
      ...
      { name: 'Coca 1.5 descartable ', price: '$8.100', desc: 'Solo para delivery o Take Away ', imageUrl: 'https://bruzz.com.ar/img/1783718243-carta3--.jpg' },
      ...
      { name: 'Coca cola 500 CC', price: '$4.000', desc: '', imageUrl: 'https://bruzz.com.ar/img/coca.jpg' },
  ...
  cervezas: {
    ...
    items: [
      ...
      { name: 'Heineken 330 CC', price: '$5.500', desc: '', imageUrl: 'https://bruzz.com.ar/img/heineken.jpg' },
      { name: 'Heineken 0.0 330 CC', price: '$4.400', desc: 'Sin Alcohol.', imageUrl: 'https://bruzz.com.ar/img/heineken.jpg' },
      { name: 'Imperial 330 CC', price: '$4.200', desc: '', imageUrl: 'https://bruzz.com.ar/img/imperial.jpg' },
