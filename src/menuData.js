export const CATEGORIAS = [
  ...
  },
  {
    ...
    imageUrl: 'https://bruzz.com.ar/img/gin.png',  
  },
  {
    id: 'postres',
    name: 'Postres',
    desc: 'Dulce final perfecto',
    imageUrl: 'https://bruzz.com.ar/img/postres.jpg',
  },
  {
    id: 'cafeteria',
    name: 'Cafetería',
    desc: 'Café, infusiones y más',
    imageUrl: 'https://bruzz.com.ar/img/cafe.jpg',
  },
];
...
export const MENU = {
  ...
  pizza: {
    ...
    items: [
      ...
      { name: 'Pizza Sin T.A.C.C.', price: '$22.000', desc: 'Masa artesanal sin TACC. Elegí la variedad que querés: Napolitana, Cuatro Quesos o Muzza y Jamón.', sinTacc: true, imageUrl: 'https://bruzz.com.ar/img/Celiacopizza.jpg' },
      { sep: 'Mini Pizzas BamBino' },
      { name: 'Mini Pizza Bambino', price: '$14.500', desc: 'Mini pizza de muzzarella + bebida + helado + juguete.', badge: 'Para los peques', imageUrl: 'https://bruzz.com.ar/img/bambino.png' },
      ...
      { name: 'Prosciutto Cotto',   price: '$22.000', desc: 'Pizza estilo napolitano, salsa de tomate fresca, mozzarella, jamón cocido, albahacas fresca, olivas verdes, orégano.', imageUrl: 'https://bruzz.com.ar/img/pizzageneral.jpg' },
      ...
      { name: 'Pizza Bruzz',        price: '$24.500', desc: 'Pizza estilo napolitano, salsa de tomate fresca, mozzarella, cebolla caramelizada con un toque de roquefort, morrón, lomo ahumado, orégano.', badge: '✦ Firma', imageUrl: 'https://bruzz.com.ar/img/image.png' },
      ...
      { name: 'Dolce Pera',         price: '$23.000', desc: 'Pizza estilo napolitano, base de aceite de oliva extra virgen, muzzarella, roquefort, pera, nueces, miel, cebolla de verdeo.', badge: '✦ Firma', imageUrl: 'https://bruzz.com.ar/img/pizzageneral.jpg' },
      { name: 'Dolce',              price: '$21.900', desc: 'Pizza estilo napolitano, base de aceite de oliva extra virgen, muzzarella, roquefort, sardo, nueces, miel.', badge: '✦ Firma', imageUrl: 'https://bruzz.com.ar/img/pizzageneral.jpg' },
      { name: 'Panceta Affumicata', price: '$23.300', desc: 'Pizza estilo napolitano, salsa de tomate fresca, mozzarella, panceta ahumada, romero, humo, queso parmesano.', badge: '✦ Firma', imageUrl: 'https://bruzz.com.ar/img/pizzageneral.jpg' },
      ...
      { name: 'Speciale',           price: '$24.300', desc: 'Pizza estilo napolitano, salsa de tomate fresca, mozzarella, morrón, jamón, huevo hilado, aceitunas, orégano.', badge: '✦ Firma', imageUrl: 'https://bruzz.com.ar/img/pizzageneral.jpg' },
  ...
  calzone: {
    ...
    items: [
      { name: 'Calzone Margherita',       price: '$18.900', desc: 'Salsa de tomate fresca, mozzarella, albahaca fresca, envuelto en masa de pizza estilo napolitano.', imageUrl: 'https://bruzz.com.ar/img/calzone.jpg' },
      { name: 'Calzone Prosciutto Cotto', price: '$22.000', desc: 'Salsa de tomate fresca, mozzarella, jamón cocido, albahacas fresca, orégano, envuelto en masa de pizza estilo napolitano.', imageUrl: 'https://bruzz.com.ar/img/calzone.jpg' },
      { name: 'Calzone Fungo',            price: '$24.700', desc: 'Salsa de tomate fresca, mozzarella, champignones y cherrys confitados en aceite de oliva, pesto Bruzz, envuelto en masa de pizza estilo napolitano.', imageUrl: 'https://bruzz.com.ar/img/calzone.jpg' },
    ],
  },
  ...
  hamburgesas: {
    ...
    items: [
      { name: 'Hamburgesa Bambino', price: '$14.600', desc: 'Burger Simple + Gaseosa + Helado + Jugete todo en UNO.', imageUrl: 'https://bruzz.com.ar/img/bambino2.png' },
      ...
      { name: 'Hamb Bruzz',         price: '$14.600', desc: 'Pan de papa Americano, carne de res, cheddar, salsa Bruzz, rúcula, cebolla morada, bacon, pepinos encurtidos, barbacoa y papas fritas.', badge: '✦ Firma', imageUrl: 'https://bruzz.com.ar/img/Bbruzz.jpg' },
      ...
      { name: 'Combo Simple',       price: '$14.800', desc: 'Hamburguesa simple mas gaseosa de 500ml.', imageUrl: 'https://bruzz.com.ar/img/combo.png' },
      { name: 'Combo Completa',     price: '$16.500', desc: 'Hamburguesa completa mas gaseosa de 500ml.', imageUrl: 'https://bruzz.com.ar/img/combo.png' },
      { name: 'Combo Bruzz',        price: '$17.200', desc: 'Hamburguesa bruzz mas gaseosa de 500ml.', imageUrl: 'https://bruzz.com.ar/img/Bbruzz.jpg' },
      { name: 'Combo Veggie',       price: '$15.400', desc: 'Hamburguesa vegana mas gaseosa de 500ml.', imageUrl: 'https://bruzz.com.ar/img/combo.png' },
  ...
  cervezas: {
    ...
    items: [
      ...
      { name: 'Balde Heineken x6',         price: '$21.000', desc: 'Paga 5 y te llevas 6.', badge: 'Balde', imageUrl: 'https://bruzz.com.ar/img/heineken.jpg' },
      { name: 'Balde Imperial Golden x6',  price: '$18.000', desc: 'Paga 5 y te llevas 6.', badge: 'Balde', imageUrl: 'https://bruzz.com.ar/img/imperial.jpg' },
      { name: 'Balde Blue Moon x6',        price: '$30.000', desc: 'Paga 5 y te llevas 6.', badge: 'Balde', imageUrl: 'https://bruzz.com.ar/img/blue.jpg' },
    ],
  },
  ...
  tragos: {
    ...
    items: [
      ...
      { sep: 'Promos' },
      { name: 'Promo Bladis',                       price: '$49.000', desc: '1 botella de Fernet Branca 750cc + 2 Cocas 1,25 lts.', badge: '🔥 Promo', imageUrl: 'https://bruzz.com.ar/img/bladis.png' },
      { sep: 'Jarras' },
      ...
      { name: 'Promo 2 Jarras de Fernet',           price: '$24.000', desc: '2 jarras de Fernet Branca con Coca-Cola.', badge: '🔥 Promo', imageUrl: 'https://bruzz.com.ar/img/FerneJ.png' },
    ],
  },
...
export const POSTRES = [
  { sep: 'Postres' },
  { name: 'Tiramisú Bruzz',          price: '$6.500', desc: 'Vanilla, queso crema, cafe, cerveza negra, cacao. Receta de la Casa.', imageUrl: 'https://bruzz.com.ar/img/tiramisu.jpg' },
