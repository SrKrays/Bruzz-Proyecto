// menuData.js — Generado el 14/06/2026 07:15
...
export const MENU = {
  ...
  pizza: {
    ...
    items: [
      { name: 'Pizza para el Ruffua', price: '$13', desc: 'snfgija bgeuhaw gbuyehadvyfuheabyugfbAS9UHSA', imageUrl: 'A', badge: 'fIRMA RUFFANA' },
      ...
      { name: 'Mini Pizza Bambino', price: '$14.501', desc: 'Mini pizza de muzzarella + bebida + helado + juguete.', imageUrl: 'https://bruzz.com.ar/img/bambino.png', badge: 'Para los peques' },
